#Display the total revenue per user and 1 for above average, 0 for below average
...
SELECT 
    ...
    CASE
        WHEN (total_revenue_of_paid_subscription + Ad_rev) - avg_total_revenue > 0 THEN 1
        ELSE 0
    END AS above_or_below_avg_total_rev
FROM
    (SELECT 
        t1.user_name,
            t1.Users_idUsers,
    ...
    average_total_user_revenue
ORDER BY above_or_below_avg_total_rev DESC